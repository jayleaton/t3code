...
<header>↑ Drag T3 Agents into the list above</header>
<button id="app" draggable="true" aria-label="Drag T3 Agents to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">T3 Agents</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged T3 Agents icon is missing.");
