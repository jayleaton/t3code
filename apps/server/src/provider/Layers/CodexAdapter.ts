          ...
          ...(mcpSession
            ? {
                ...
                appServerArgs: [
                  ...
                  ...(mcpSession.workspaceEndpoint
                    ? [
                        "-c",
                        `mcp_servers.t3-workspace.url=${mcpSession.workspaceEndpoint}`,
                        "-c",
                        'mcp_servers.t3-workspace.bearer_token_env_var="T3_MCP_BEARER_TOKEN"',
                      ]
                    : []),
                  ...(mcpSession.gatewayEndpoint
                    ? [
                        "-c",
                        `mcp_servers.t3-gateway.url=${mcpSession.gatewayEndpoint}`,
                        "-c",
                        'mcp_servers.t3-gateway.bearer_token_env_var="T3_MCP_BEARER_TOKEN"',
                      ]
                    : []),
                ],
